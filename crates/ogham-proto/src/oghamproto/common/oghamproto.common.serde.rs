...
impl serde::Serialize for SourceLocation {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("oghamproto.common.SourceLocation", len)?;
        if !self.file.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SourceLocation {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct oghamproto.common.SourceLocation")
            }
        ...
        deserializer.deserialize_struct("oghamproto.common.SourceLocation", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SourceSpan {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("oghamproto.common.SourceSpan", len)?;
        if self.start != 0 {
...
impl<'de> serde::Deserialize<'de> for SourceSpan {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct oghamproto.common.SourceSpan")
            }
        ...
        deserializer.deserialize_struct("oghamproto.common.SourceSpan", FIELDS, GeneratedVisitor)
    }
}
